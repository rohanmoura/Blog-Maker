                    ...
                    <CardContent>
                        <div className="flex flex-col gap-y-6">
                            ...
                            <div className="grid gap-2">
                                ...
                                <Input name={fields.subdirectory.name} key={fields.subdirectory.key} defaultValue={fields.subdirectory.initialValue}
                            ...
                            <div className="grid gap-2">
                                ...
                                <Textarea name={fields.description.name} key={fields.description.key} defaultValue={fields.description.initialValue}
